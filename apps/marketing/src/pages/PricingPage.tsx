                  ...
                  <div className="card-inner">
                    ...
                    <div className="card-body">
                      <div className="plan-pricing">
                        ...
                        <button className="cta-button outline" onClick={() => openRegisterModal()}>
                  ...
                  <div className="card-inner">
                    ...
                    <div className="card-body">
                      <div className="plan-pricing">
                        ...
                        <button className="cta-button primary" onClick={() => openRegisterModal()}>
        ...
        <section className="final-cta-section">
          <div className="container">
            <div className="cta-content">
              ...
              <button className="cta-button-final" onClick={() => openRegisterModal()}>
                <div className="button-glow"></div>
                <span className="gradient-button-large">Start Building Leads for Free</span>
              </button>
            </div>
          </div>
        </section>
