...
export default function ProgramWelcome({
  ...
  const workspaceUrlPrefix = `https://app.cliqo.com/${workspace.slug}`;
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] px-10 py-5">
            ...
            <Text className="mb-4 text-sm leading-5 text-neutral-800">
              ...
              more creators applying to join your program.
            </Text>
            <Text className="mb-4 text-sm leading-5 text-neutral-800">
              2. <span className="font-medium">Connect your bank account</span>:{" "}
              <Link
                href="https://cliqo.com/help/article/how-to-set-up-bank-account"
                className="font-semibold text-neutral-800 underline underline-offset-2"
              >
                Set up a bank account
              </Link>{" "}
              to start paying out commissions to your creators.
            </Text>
            <Text className="mb-4 text-sm leading-5 text-neutral-800">
            ...
            <Text className="mb-4 text-sm leading-5 text-neutral-800">
              4. <span className="font-medium">Invite your creators</span>:
              Easily{" "}
              <Link
                href={`${workspaceUrlPrefix}/program/creators`}
                className="font-semibold text-neutral-800 underline underline-offset-2"
              >
                invite influencers, creators, and users
              </Link>{" "}
              to your program, or{" "}
              <Link
                href="https://cliqo.com/docs/creators/embedded-referrals"
                className="font-semibold text-neutral-800 underline underline-offset-2"
              >
            ...
            <Text className="mb-0 text-sm leading-5 text-neutral-800">
              ...
              to incentivize your creators to drive more traffic and
              conversions.
            </Text>
