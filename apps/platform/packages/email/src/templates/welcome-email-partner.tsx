...
export default function WelcomeEmailCreator({
  name = "Brendon Urie",
  ...
  return (
    <Html>
      <Head />
      <Preview>Welcome to Cliqo Creators</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-xl font-semibold text-black">
              Welcome {name || "to Cliqo Creators"}!
            </Heading>
            ...
            <Text className="mb-4 text-sm leading-6 text-gray-600">
              ...
              : Start by{" "}
              <Link
                href="https://cliqo.com/creator-profile"
                className="font-semibold text-black underline underline-offset-4"
              >
                completing your creator profile
              </Link>
              . This will help you stand out from other creators in our creator
              network.
            </Text>
            ...
            <Text className="mb-4 text-sm leading-6 text-gray-600">
              ...
              :{" "}
              <Link
                href="https://cliqo.com/connect-payouts"
                className="font-semibold text-black underline underline-offset-4"
              >
              ...
              receive payouts.{" "}
              <Link
                href="https://cliqo.com/payouts-guide"
                className="font-semibold text-black underline underline-offset-4"
              >
                Learn more ↗
              </Link>
            ...
            <Text className="mb-4 text-sm leading-6 text-gray-600">
              ...
              : If you haven't already, join a creator program and start
            ...
            <Section className="mb-8">
              <Link
                ...
                href="https://cliqo.com/creators-dashboard"
              >
