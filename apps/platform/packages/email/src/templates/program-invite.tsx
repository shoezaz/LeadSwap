...
export default function CreatorInvite({
  ...
  rewards = [
    {
      icon: "/assets/email-assets/icons/invoice-dollar.png",
      label: "Earn up to 65% per sale for 1 year",
    },
    {
      icon: "/assets/email-assets/icons/gift.png",
      label: "New users get 20% off for 3 months",
    },
  ],
  bounties = [
    {
      icon: "/assets/email-assets/icons/heart.png",
      label: "Create a YouTube video about Acme",
    },
    {
      icon: "/assets/email-assets/icons/trophy.png",
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-8 max-w-[600px] px-8 py-8">
            ...
            <Text className="text-sm leading-6 text-neutral-600">
              ...
              {program.name} invited you to join their creator program on Cliqo.
            </Text>

            <Text className="text-sm leading-6 text-neutral-600">
              {program.name} uses{" "}
              <Link
                href="https://cliqo.com/creators"
                target="_blank"
                className="font-semibold text-neutral-800 underline underline-offset-2"
              >
                Cliqo
              </Link>{" "}
              to power their creator program and wants to work with great people
              like you!
            </Text>
            ...
            <Section className="my-8">
              <Link
                ...
                href={`https://creator.cliqo.com/${program.slug}/register?email=${encodeURIComponent(email)}&next=/programs/${program.slug}`}
              >
                Accept Invite
              </Link>
            </Section>
