import { currencyFormatter, CLIQO_WORDMARK, formatDate } from "@leadswap/utils";
import {
  Body,
  Container,
  Head,
...
export default function CreatorPayoutConfirmed({
          ...
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-neutral-600">
              ...
              {startDate && endDate ? (
                <>
                  {" "}
                  for creator commissions made from{" "}
            ...
            <Section className="mb-12 mt-8">
              <Link
                ...
                href={`${PARTNERS_DOMAIN}/payouts?payoutId=${payout.id}`}
              >
                View payout
              </Link>
            </Section>
