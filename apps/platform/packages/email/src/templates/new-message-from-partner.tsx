...
export default function NewMessageFromCreator({
  workspaceSlug = "acme",
  creator = {
    id: "pn_xxx",
    name: "Marvin Ta",
  ...
  return (
    <Html>
      <Head />
      <Preview>New message from {creator.name}</Preview>
      <Tailwind>
          ...
          <Container className="mx-auto my-8 max-w-[600px] px-8 py-8">
            ...
            <Section className="my-8">
              ...
              <Link
                ...
                href={`https://app.cliqo.com/${workspaceSlug}/program/creators/${creator.id}`}
              >
                View profile in Cliqo
              </Link>
            </Section>
            ...
            <Section className="rounded-xl border border-solid border-neutral-200 p-6">
              ...
              <Link
                ...
                href={`https://app.cliqo.com/${workspaceSlug}/program/messages/${creator.id}`}
              >
                View in Cliqo
              </Link>
            </Section>
