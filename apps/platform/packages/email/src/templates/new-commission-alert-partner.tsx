import { currencyFormatter, CLIQO_WORDMARK, getPrettyUrl } from "@leadswap/utils";
import {
  Body,
  Container,
  Head,
...
export default function NewCommissionAlertCreator({
  ...
  shortLink = "https://refer.cliqo.com/steven",
}: {
  email: string;
  program: {
    name: string;
  ...
  const linkToEarnings = `${PARTNERS_DOMAIN}/programs/${program.slug}/earnings`;
