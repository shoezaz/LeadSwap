        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Text className="mb-6 text-sm leading-6 text-neutral-600">
              ...
              already associated with another Cliqo Creators account.
            </Text>
            ...
            <Section className="mb-6 rounded-lg border border-solid border-blue-200 bg-blue-50 px-4 py-2">
              ...
              <Text className="text-sm leading-6 text-blue-700">
                ...
                to one Cliqo creator account at a time. This helps us prevent
            ...
            <Section className="mb-6">
              ...
              <Text className="mb-3 text-sm leading-6 text-neutral-600">
                ...
                method might already be connected to another Cliqo creator account
                using a different email address.
              </Text>
              <Text className="mb-3 text-sm leading-6 text-neutral-600">
                <strong>2. Merge your creator accounts:</strong> If you have
                multiple creator accounts and need to consolidate them, you can
                easily{" "}
                <Link
                  href="https://cliqo.com/help/article/merging-creator-accounts"
              ...
              <Text className="mb-3 text-sm leading-6 text-neutral-600">
                ...
                creator account is for a different entity, you can{" "}
                <Link
