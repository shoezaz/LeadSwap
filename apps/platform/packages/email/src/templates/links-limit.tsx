import { CLIQO_WORDMARK, capitalize, getNextPlan, nFormatter } from "@leadswap/utils";
import {
  Body,
  Container,
  Head,
...
export default function LinksLimitAlert({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Your Cliqo workspace, {name} has used {percentage.toString()}% of its
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-lg font-medium text-black">
              Cliqo Links Limit Alert
            </Heading>
            <Text className="text-sm leading-6 text-black">
              Your Cliqo workspace,{" "}
              <Link
                href={`https://app.cliqo.com/${slug}`}
            ...
            <Section className="mb-8">
              <Link
                ...
                href={`https://app.cliqo.com/${slug}/upgrade`}
              >
                Upgrade my plan
              </Link>
            </Section>
