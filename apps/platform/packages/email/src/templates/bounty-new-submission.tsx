...
export default function NewBountySubmission({
  ...
  creator = {
    name: "John Doe",
    image:
      "https://dubassets.com/creators/pn_H4TB2V5hDIjpqB7PwrxESoY3/image_wCBZlIJ",
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-8 max-w-[600px] px-8 py-8">
            ...
            <Section className="mt-6 text-center">
              <Link
                href={`https://app.cliqo.com/${workspace.slug}/program/bounties/${bounty.id}?submissionId=${submission.id}`}
