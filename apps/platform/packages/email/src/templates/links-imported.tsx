import { CLIQO_WORDMARK, linkConstructor, pluralize, timeAgo } from "@leadswap/utils";
import {
  Body,
  Column,
  Container,
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              from {provider} into your Cliqo workspace,{" "}
              <Link
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              <Link
                href="https://cliqo.com/help/article/how-to-add-custom-domain#step-2-configure-your-domain"
                className="font-medium text-blue-600 no-underline"
              >
