import { capitalize, currencyFormatter, CLIQO_WORDMARK } from "@leadswap/utils";
import {
  Body,
  Column,
  Container,
...
export default function NewSaleAlertProgramOwner({
  ...
  const salesLink = `https://app.cliqo.com/${workspace.slug}/program/commissions?creatorId=${creator.id}`;
  const notificationPreferencesLink = `https://app.cliqo.com/${workspace.slug}/settings/notifications`;
