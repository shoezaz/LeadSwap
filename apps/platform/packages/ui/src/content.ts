...
export const FEATURES_LIST = [
  {
    id: "links",
    title: "Cliqo Links",
    description: "Powerful UGC campaigns",
    icon: DubLinksIcon,
    href: "/links",
  },
  {
    id: "partners",
    title: "Cliqo Partners",
  ...
  {
    title: "Cliqo Integrations",
    description: "Connect Cliqo with your favorite tools",
    icon: Toggle2Fill,
    href: "/integrations",
  },
];
...
export const SOLUTIONS: NavItemChildren = [
  ...
  },
  {
    ...
    description: "Intelligent audience insights and campaign tracking",
    href: "/solutions/creators",
  },
  {
    icon: UsersFill,
    title: "Creator Management",
    description: "Manage creators and automate payouts",
    href: "/partners",
  },
  {
    label: "SDKs",
...
export const LEGAL_PAGES = [
  { name: "Creator Program Terms", slug: "creators" },
  { name: "DPA", slug: "dpa" },
