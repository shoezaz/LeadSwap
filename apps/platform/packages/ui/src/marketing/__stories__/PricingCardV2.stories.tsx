...
const meta: Meta<typeof PricingCardV2> = {
  title: "Marketing/Pricing/PricingCardV2",
  component: PricingCardV2,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
...
export default meta;
type Story = StoryObj<typeof PricingCardV2>;
...
export const Pro: Story = {
  args: {
    ...
    features: [
      ...
      { text: "Link folders", iconSrc: FEATURE_ICONS.folders, hasTooltip: true },
      { text: "Deep links", iconSrc: FEATURE_ICONS.deeplinks, hasTooltip: true },
    ],
  },
};
...
export const Advanced: Story = {
  args: {
    ...
    features: [
      ...
      { text: "Priority Slack support", iconSrc: FEATURE_ICONS.slack, fillNone: true },
    ],
  },
};
