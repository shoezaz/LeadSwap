...
/**
 * PricingCardSquare - Cliqo Design System
 * Squared version: No rounded corners on buttons/badges/borders.
 */
...
export interface PricingCardSquareProps {
...
export function PricingCardSquare({
    name,
    monthlyPrice,
    yearlyPrice,
    description,
    ...
    return (
        <div
            className={`${!isLast ? "border-r " : ""}flex flex-col h-full relative top-0 bg-neutral-950 border-neutral-800 transition-colors hover:border-neutral-700`}
        >
            <div
            ...
            >
                ...
                <div>
                    <div className="items-center flex gap-[8px]">
                        ...
                        {isPopular && (
                            // Removed rounded-[2097150rem]
                            <div className="font-medium text-center uppercase whitespace-nowrap w-fit bg-violet-500/20 text-violet-400 border border-violet-500/30 text-[10px] leading-[10px] pt-[5px] pr-2 pb-[5px] pl-2">
                                Popular
                            </div>
                        )}
                    </div>
                ...
                {/* CTA Button - Square style */}
                <div className="flex gap-[12px]">
                    <a
                        href={ctaHref}
                        // Removed rounded-[2097150rem] to make it square
                        className={`block font-medium text-center w-full text-[14px] leading-[20px] py-2.5 transition-colors ${ctaSecondary
            ...
            {showPartnersFooter && partnersFooterHref && (
                <div className="flex flex-col grow justify-end">
                    <div className="relative bg-neutral-800/50 z-[0]">
                        {/* Removed rounded-bl and rounded-br */}
                        <div className="border-b border-l border-r -ml-px -mr-px pointer-events-none relative h-[10px] bg-neutral-950 border-neutral-800 z-[10]" />
                        <a
                        ...
                        >
                            {/* Removed rounded-sm */}
                            <div className="items-center flex justify-center w-[18px] h-[18px] bg-violet-500/20 shrink-[0]">
                                {partnersFooterIcon && (
