    ...
    if (disabledTooltip) {
      return (
        <Tooltip content={disabledTooltip}>
          <div
            className={cn(
              "flex h-10 w-full cursor-not-allowed items-center justify-center gap-x-2 rounded-md border border-border-default bg-bg-subtle px-4 text-sm text-content-muted transition-all focus:outline-none",
              {
          ...
          >
            ...
            {shortcut && (
              <kbd
                className={cn(
                  "hidden rounded border border-border-default bg-bg-subtle px-2 py-0.5 text-xs font-light text-content-muted md:inline-block",
                  {
                    "bg-bg-subtle": variant?.endsWith("outline"),
                  },
                  shortcutClassName,
                )}
              >
      ...
      <button
        ...
        className={cn(
          ...
          props.disabled || loading
            ? "cursor-not-allowed border-border-default bg-bg-subtle text-content-muted outline-none"
        ...
        {shortcut && (
          <kbd
            className={cn(
              ...
              {
                "bg-neutral-700 text-neutral-400 group-hover:bg-neutral-600 group-hover:text-neutral-300 dark:bg-neutral-200 dark:text-neutral-600 dark:group-hover:bg-neutral-300 dark:group-hover:text-neutral-700":
                  variant === "primary",
                "bg-bg-subtle text-content-muted group-hover:bg-bg-muted group-hover:text-content-subtle":
                  variant === "secondary",
                "bg-bg-subtle text-content-subtle group-hover:bg-bg-emphasis":
                  variant === "outline",
