        ...
        <Drawer.Portal>
          ...
          <Drawer.Content
            ...
            className={cn(
              ...
              "rounded-t-[10px] border-t border-border-default bg-bg-default",
              className,
            )}
          >
    ...
    >
      <Dialog.Portal>
        <Dialog.Overlay
          ...
          id="modal-backdrop"
          className="animate-fade-in fixed inset-0 z-40 bg-bg-subtle bg-opacity-50 backdrop-blur-md dark:bg-bg-inverted/50"
        />
        <Dialog.Content
          ...
          className={cn(
            ...
            "border border-border-default bg-bg-default p-0 shadow-xl sm:rounded-2xl",
