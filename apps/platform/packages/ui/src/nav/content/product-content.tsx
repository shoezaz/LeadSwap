import { cn, createHref } from "@leadswap/utils";
...
const products = [
  {
    ...
    title: "Cliqo Links",
    description: "Powerful UGC campaigns for modern marketing teams.",
    href: "/links",
    color: "#f4950c",
...
const largeLinks = [
  {
    ...
    description: "Enhance your campaigns",
    href: "/integrations",
    graphic: (
  ...
  },
  {
    ...
    graphic: (
      <div className="absolute -right-4 top-2.5 h-[180px] w-[240px] [mask-image:linear-gradient(90deg,black_50%,transparent_95%)] dark:opacity-60">
        <Image src="/assets/product-showcase/enrichment.png" alt="" fill />
      </div>
    ),
  },
];
