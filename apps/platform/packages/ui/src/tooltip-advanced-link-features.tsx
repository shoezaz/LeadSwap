...
const advancedLinkFeatures = [
  {
    ...
    href: "https://cliqo.com/help/article/custom-link-previews",
  },
  {
    icon: Earth,
    text: "Geo/device targeting",
    href: "https://cliqo.com/help/article/geo-targeting",
  },
  {
    icon: InputPasswordPointer,
    text: "Password protection",
    href: "https://cliqo.com/help/article/password-protected-links",
  },
  {
    icon: Timer2,
    text: "Link expiration",
    href: "https://cliqo.com/help/article/link-expiration",
  },
  {
    icon: Incognito,
    text: "Link cloaking",
    href: "https://cliqo.com/help/article/link-cloaking",
  },
];
