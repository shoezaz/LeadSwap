...
export const DUB_DOMAINS = [
  {
    ...
    primary: true,
    archived: false,
    placeholder: "https://app.cliqo.com/help",
    allowedHostnames: [],
    ...
    ? [
      {
        ...
        primary: true,
        archived: false,
        placeholder: "https://cliqo.com/help/article/what-is-cliqo",
        allowedHostnames: [],
        description:
          "Premium short domain on Cliqo – only available on our Pro plan and above.",
        projectId: DUB_WORKSPACE_ID,
      },
      {
      ...
      },
      {
        ...
        archived: false,
        placeholder:
          "https://www.figma.com/design/YAfTk6SGV2HcSvL2415oED/Cliqo.co-Brand-Assets-(Public)?node-id=1-36593&t=QMKQNtUzxSSzG3hX-1",
