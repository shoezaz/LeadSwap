...
import { DubCraftedShield, Tooltip } from "@leadswap/ui";
import { DUB_WORKSPACE_ID } from "@leadswap/utils";
import { cn } from "@leadswap/utils/src";
  ...
  return (
    <Wrapper integration={integration}>
      ...
      <h3 className="mt-4 flex items-center gap-1.5 text-sm font-semibold text-neutral-800">
        {integration.name}
        {dubCrafted && (
          <Tooltip content="This is an official integration built and maintained by Cliqo">
            <div>
