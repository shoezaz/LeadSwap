...
import { Button, Input, useMediaQuery } from "@leadswap/ui";
        ...
        {authMethod === "email" && (
          <label>
            ...
            <input
              ...
              size={1}
              className={cn(
                "block w-full min-w-0 appearance-none rounded-md border border-neutral-300 bg-white px-3 py-2 text-gray-900 placeholder-neutral-400 shadow-sm focus:border-black focus:outline-none focus:ring-black sm:text-sm",
                {
                  "pr-10": isPending,
                },
              )}
