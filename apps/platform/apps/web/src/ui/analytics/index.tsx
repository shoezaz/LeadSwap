...
/*
  ...
  1. Workspace analytics page, e.g. app.cliqo.com/dub/analytics
  2. Public stats page, e.g. app.cliqo.com/share/dash_6NSA6vNm017MZwfzt8SubNSZ
  3. Partner program links page, e.g. creator.cliqo.com/campaigns/dub/analytics
*/
