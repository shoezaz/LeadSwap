...
import { BlurImage, buttonVariants, useRouterStuff } from "@leadswap/ui";
      ...
      [
        {
          id: "clicks",
          label: "Views",
          colorClassName: "text-sky-500/50",
          conversions: false,
        },
        ...(showConversions
          ? [
            {
              id: "leads",
              label: "Submissions",
              colorClassName: "text-indigo-500/50",
              conversions: true,
            },
            {
              id: "sales",
              label: "Earnings",
              colorClassName: "text-emerald-400/50",
              conversions: true,
            },
          ]
          : []),
    ...
    <div className="animate-slide-up-fade pointer-events-none absolute inset-0 flex items-center justify-center pt-24">
      <div className="pointer-events-auto flex flex-col items-center">
        ...
        <p className="mt-4 max-w-sm text-center text-sm text-neutral-500">
          ...
          Business Plan and start tracking conversion events with Cliqo.{" "}
          <Link
            href="https://d.to/conversions"
            target="_blank"
