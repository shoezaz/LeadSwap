...
import { MiniAreaChart, useMediaQuery, useRouterStuff } from "@leadswap/ui";
import { capitalize, cn, fetcher } from "@leadswap/utils";
...
export default function EventsTabs() {
  ...
  return (
    <div className="grid w-full grid-cols-3 gap-2 overflow-x-auto sm:gap-4">
      {[
        { id: "clicks", label: "Views" },
        { id: "leads", label: "Submissions" },
        { id: "sales", label: "Earnings" },
      ].map(({ id: event, label }) => (
        <button
          key={event}
          className={cn(
