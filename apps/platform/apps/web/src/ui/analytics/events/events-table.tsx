...
import { Globe, Magnifier } from "@leadswap/ui/icons";
import {
  CONTINENTS,
  COUNTRIES,
  REGIONS,
        ...
        },
        {
          ...
          cell: ({ getValue }) => (
            <CustomerRowItem
              ...
              href={
                partnerPage
                  ? `/campaigns/${programSlug}/customers/${getValue().id}`
  ...
  const { table, ...tableProps } = useTable({
    ...
    emptyState: (
      <EmptyState
        ...
        description={`Events will appear here when your content ${tab === "clicks" ? "gets views" : `converts to ${tab === "leads" ? "submissions" : "earnings"}`}`}
      />
    ),
