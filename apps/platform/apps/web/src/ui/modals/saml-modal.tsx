...
import { SAML_PROVIDERS } from "@leadswap/utils";
      ...
      <div className="flex flex-col space-y-6 bg-neutral-50 px-4 py-8 text-left sm:px-16">
        ...
        >
          <div>
            ...
            {currentProvider ? (
              <a
                href={`https://cliqo.com/help/article/${selectedProvider}-saml`}
                target="_blank"
              ...
              <a
                href="https://cliqo.com/help/category/saml-sso"
                target="_blank"
                className="ml-2 mt-2 block text-sm text-neutral-500 underline"
              >
                  ...
                  <InfoTooltip
                    content={
                      <SimpleTooltipContent
                        title={`Your ${currentProvider.samlModalCopy} is the URL to your SAML provider's metadata.`}
                        cta="Learn more."
                        href={`https://cliqo.com/help/article/${selectedProvider}-saml#step-4-copy-the-metadata-url`}
                      />
                    }
                  />
                </div>
