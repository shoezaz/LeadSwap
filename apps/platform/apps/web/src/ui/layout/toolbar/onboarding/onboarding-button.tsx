...
import { Button, Popover, useLocalStorage, useMediaQuery } from "@leadswap/ui";
import { CircleDotted, ExpandingArrow } from "@leadswap/ui/icons";
            ...
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-300">
                  Get familiar with Cliqo by completing the{" "}
