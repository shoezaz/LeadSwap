...
import { BlurImage, Popup, PopupContext } from "@leadswap/ui";
import { X } from "lucide-react";
import { motion } from "motion/react";
import Link from "next/link";
import { useContext } from "react";

const CHANGELOG_URL = "https://cliqo.com/builder";
const CHANGELOG_IMAGE_URL = "https://assets.dub.co/blog/new-link-builder.jpg";
const CHANGELOG_TITLE = "Introducing the new Cliqo Link Builder";
