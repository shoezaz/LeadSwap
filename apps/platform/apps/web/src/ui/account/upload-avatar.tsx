...
import { Button, FileUpload, getUserAvatarUrl } from "@leadswap/ui";
        ...
        <div className="mt-1 flex items-center gap-4">
          ...
          {image && (
            <button
              ...
              className="flex h-9 items-center gap-2 rounded-md border border-neutral-300 bg-white px-3 text-sm text-red-600 transition-colors hover:bg-red-50 hover:border-red-300"
