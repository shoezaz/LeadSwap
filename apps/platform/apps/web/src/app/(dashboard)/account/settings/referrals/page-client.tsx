...
import { DubEmbed } from "@leadswap/embed-react";
import { CursorRays, Hyperlink, InvoiceDollar, UserCheck } from "@leadswap/ui/icons";
  ...
  if (!publicToken) {
    return (
      <AnimatedEmptyState
        ...
        description="Activate your referral link to share the word about Cliqo and earn cash rewards"
        cardContent={
          <>
