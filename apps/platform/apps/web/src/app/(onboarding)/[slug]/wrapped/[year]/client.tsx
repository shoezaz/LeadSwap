...
import { BlurImage, ExpandingArrow, STAGGER_CHILD_VARIANTS } from "@leadswap/ui";
import { cn, OG_AVATAR_URL, smartTruncate } from "@leadswap/utils";
import { COUNTRIES } from "@leadswap/utils/src/constants/countries";
    ...
    <div className="relative mx-auto my-10 max-w-lg px-4 sm:px-8">
      ...
      <div className="animate-slide-up-fade mb-4 mt-8 rounded-lg border border-neutral-200 bg-white p-2 shadow-md [animation-delay:450ms] [animation-duration:1s] [animation-fill-mode:both]">
        <div
          ...
          style={{
            backgroundImage: `url(/assets/product-showcase/enrichment.png)`,
      ...
      <Link
        ...
        href="https://cliqo.com/blog/2024"
        target="_blank"
      >
        <Image
          src="/assets/product-showcase/enrichment.png"
          alt="Cliqo logo with confetti"
          width={1838}
          height={1172}
