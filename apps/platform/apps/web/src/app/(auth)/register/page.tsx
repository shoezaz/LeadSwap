        ...
        <div className="flex min-h-screen w-full bg-white font-sans text-[#10161e]">
            ...
            <div className="flex w-full flex-col justify-between p-8 lg:w-[45%] xl:w-[40%] relative z-10">
                ...
                <div className="mx-auto w-full max-w-[400px] flex flex-col justify-center">
                    ...
                    {/* Login Area */}
                    <div className="flex h-[64px] w-full items-center justify-between rounded-[8px] bg-white p-4 shadow-[0px_4px_6px_-2px_rgba(16,24,40,0.03),0px_12px_16px_-4px_rgba(16,24,40,0.08)] border border-[#eef0f2]">
                        <div className="flex flex-col">
                            <span className="text-[14px] font-medium leading-[20px]">
                                Already have an account?
                            </span>
                            <Link href="/login" className="text-[14px] leading-[20px] text-[#0066ff]">
                                Log in
                            </Link>
                        </div>
                    </div>
